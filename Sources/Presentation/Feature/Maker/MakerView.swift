...
struct MakerView: View {
    @Query(sort: [SortDescriptor<CreatedSecretMessage>(\.createdDate, order: .reverse)])
    var messages: [CreatedSecretMessage]
        ...
        GeometryReader { geo in
            VStack(spacing: 4) {
                ...
                RotatingShapeButtonView()
                    ...
                    .environment(\.shapeButtonStyle, ShapeButtonStyle(ratio: 0.35))
